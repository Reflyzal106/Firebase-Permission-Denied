# [SOLVED] Firebase-Permission-Denied
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/firebase-permission-denied)
>
...
The error occurs because the user's data is not accessible due to permission issues. Ensure that the user has write access to their own data in Firebase. You can do this by adding the "users" service to the rules for your Firebase project.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/firebase-permission-denied)**
